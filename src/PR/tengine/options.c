...
#ifdef PLATFORM_3DS
/* 3DS swap-sticks row: the String is reassigned each Draw to show which stick is the analog MOVE stick
 * (fwd/back + strafe). NB the LARGE_FONT the options menu draws with has NO ':' or '-' glyph (they alias other
