...
static char	text_look_cpad[]   = {"look circle pad"};	// swap_sticks 0 (default): Circle Pad looks, nub moves
static char	text_look_cstick[] = {"look c stick"};		// swap_sticks 1: nub (C-stick) looks, Circle Pad moves
#endif
...
#ifdef PLATFORM_3DS
			{	extern int g_cfg_swap_sticks;	/* row shows which stick LOOKS: swap 0 = Circle Pad, swap 1 = C-stick */
